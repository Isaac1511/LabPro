...
#Creating resource group - Removed RG using sandbox RG already created.
...
# Create virtual network - Removed 'depends_on' since RG was removed
...
# Add Custom IP Inbound & Outbound rules - Updated my 'depends_on' from sec rule to sec group tfnsgname.
